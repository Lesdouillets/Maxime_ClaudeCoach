...
interface RunFormProps {
  /** ISO date "YYYY-MM-DD" — defaults to today when null */
  sessionDate: string | null;
  /** Called when the user taps Continuer after save + analysis */
  onContinue: () => void;
}

export default function RunForm({ sessionDate, onContinue }: RunFormProps) {
  ...
  const paceVsTarget = pace && targetPace ? pace - targetPace : null;
  ...
  }, [distanceKm, minutes, seconds, avgHr, elevGain, comment, pace, todayPlan, sessionDate]);
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #1a1a1a" }}>
        <div className="p-4 flex items-center gap-4" style={{ background: "#111" }}>
          <div
          ...
          <div className="flex-1">
            ...
            <div className="flex items-end gap-2">
              <input
                ...
                placeholder="0.0"
                disabled={saved}
                className="bg-transparent border-none p-0 font-display text-4xl w-28 focus:outline-none disabled:cursor-default"
                style={{ color: "white" }}
                min="0"
                step="0.1"
              />
            ...
            <div className="flex items-end gap-2">
              <div className="flex items-end gap-1">
                <input
                  ...
                  placeholder="00"
                  disabled={saved}
                  className="bg-transparent border-none p-0 font-display text-4xl w-16 text-center focus:outline-none disabled:cursor-default"
                  style={{ color: "white" }}
                  min="0"
                />
          ...
          <div className="p-4" style={{ background: "#111" }}>
            ...
            <div className="flex items-end gap-1">
              <input
                ...
                placeholder="—"
                disabled={saved}
                className="bg-transparent border-none p-0 font-display text-3xl w-20 focus:outline-none disabled:cursor-default"
                style={{ color: "white" }}
                min="0"
              />
      ...
      <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #1a1a1a" }}>
        ...
        <textarea
          ...
          className="w-full px-4 pb-4 pt-2 text-sm resize-none focus:outline-none disabled:cursor-default"
          style={{ background: "#111", color: "#ccc", minHeight: "90px", border: "none" }}
          rows={3}
        />
      </div>
