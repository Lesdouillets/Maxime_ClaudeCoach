...
const COL_HEADER_STYLE = { ...JETBRAINS_MONO_LABEL, fontSize: 10, color: "#444" };
    ...
    >
      <div className="flex items-start justify-between px-4 pt-4 pb-3">
        <div className="flex-1 min-w-0 pr-2">
          <p style={{ ...JETBRAINS_MONO_LABEL, fontSize: 11, lineHeight: "13px", color: "#CDFF00" }}>
            Exercice en cours
          </p>
        ...
        <button
          ...
          aria-label="Note"
        >
          <NoteIcon size={16} color="#555" />
        </button>
      </div>

      {exercise.coachNote && (
        <p className="px-4 pb-2 text-xs italic" style={{ color: "#555" }}>
          ↳ {exercise.coachNote}
        </p>
      )}
      ...
      <div className="pb-3" style={{ borderTop: "1px solid #1a1a1a" }}>
        <div
        ...
        {(exercise.setLogs ?? []).map((set, idx) => {
          ...
          return (
            <div
              ...
              style={{
                gap: 8,
                borderLeft: isActiveRow ? "3px solid #CDFF00" : "3px solid transparent",
            ...
            >
              <div className="flex-1">
                <span style={{ ...ARCHIVO_WIDE_BOLD, fontSize: 18, lineHeight: 1, color: isDone ? "#fff" : isActiveRow ? "#CDFF00" : "#444" }}>
              ...
              <div className="flex-1">
                {isDone ? (
                  ...
                  <div
                    ...
                    style={{ border: `1px solid ${isActiveRow ? "#CDFF00" : "#2a2a2a"}` }}
                  >
                    <input
                      type="number"
                      ...
                      style={{ ...NUM_STYLE, padding: 0, color: isActiveRow ? "#CDFF00" : "#444", border: "none", background: "transparent", boxShadow: "none" }}
                      min={0}
                      step={1}
                    />
                  </div>
              ...
              >
                {isDone ? (
                  <button
                    ...
                    style={{ background: "#CDFF00", border: "1px solid #CDFF00" }}
                  ...
                  <button
                    ...
                    className="aspect-square h-full rounded-lg flex items-center justify-center press-effect"
                    style={{
                      border: `1px solid ${isActiveRow ? "#CDFF00" : "#2a2a2a"}`,
        ...
        <button
          ...
          style={{ background: "transparent", border: "1px dashed #2a2a2a", color: "#555" }}
        >
